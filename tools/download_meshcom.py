...
def get_target_hardware(asset):
    ...
    "wireless-paper.bin": "wirelesspaper",
    "E22-DevKitC.bin": "e22",
    ...
    "wireless-paper.bin": "bootloader-s3.bin",
    ...
    "T3_S3_V13.bin" : "bootloader-s3.bin",
    "t_connect_pro.bin" : "bootloader-s3.bin",
    "ttgo-lora32-v21.bin" : "bootloader.bin",
    "t_deck.bin" : "bootloader-s3.bin",
    "t_deck_plus.bin" : "bootloader-s3.bin",
    "t_deck_pro.bin" : "bootloader-s3.bin",
    ...
    "wireless-paper.bin": "safeboot-s3.bin",
    ...
    "T3_S3_V13.bin" : "safeboot-s3.bin",
    "t_connect_pro.bin" : "safeboot-s3.bin",
    "ttgo-lora32-v21.bin" : "safeboot.bin",
    "t_deck.bin" : "safeboot-s3.bin",
    "t_deck_plus.bin" : "safeboot-s3.bin",
    "t_deck_pro.bin" : "safeboot-s3.bin",
    "wiscore_rak4631.uf2" : "wiscore_rak4631.uf2",
    "wiscore_rak4631.zip" : "wiscore_rak4631.zip",
    "heltec_t114.uf2" : "heltec_t114.uf2",
    "heltec_t114.zip" : "heltec_t114.zip",
