...
### 3. PR Description (English, Detailed)
Every PR **must** include a detailed description written in **English**. All
project-facing text (PR descriptions, docs, code comments) is in English.
