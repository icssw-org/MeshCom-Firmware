...
String getHardwareLong(uint8_t hwid)
{
    ...
    if(ihw == 51)
        ihw=25;
    // Mapping for LILYGO T-ETH-ELITE (ESP32_S3_T_ETH_ELITE)
    if(ihw == 53)
        ihw=26;
